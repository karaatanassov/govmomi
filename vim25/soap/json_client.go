		...
		if resp.StatusCode == 500 {
			...
			f := &Fault{
				XMLName: xml.Name{
					...
					// declared in vsan namespace e.g. "vsan:InvalidLogin"?
					Space: c.Namespace,
					// TODO: I am unsure how the InvalidLoginFault is formed.
					// The code below is wild guess i.e. SOAP type name + "Fault" suffix.
					Local: reflect.TypeOf(serverErr).Name() + "Fault",
				},
				String: faultStringStruct.FaultString,
				Code:   "ServerFaultCode", // TODO: validate this is the only value
			}
